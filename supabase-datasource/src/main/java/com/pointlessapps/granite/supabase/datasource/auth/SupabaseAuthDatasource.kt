...
internal class SupabaseAuthDatasourceImpl(
    ...
    override suspend fun signInWithGoogle(googleIdToken: String) = client.auth.signInWith(IDToken) {
    ...
    override suspend fun signInAnonymously() = client.auth.signInAnonymously()
}
